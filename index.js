...
// const superbowlWin = record.find(function(value){
//     if(value.result === 'W') {
//         return value.year
//     } 
// })
...
// const sadReality = function (record) {
//     const loss = record.filter(function(i){
//         if (i.result !== 'W') {
//             return 'undefined'
//         }
//     })
//     return loss.year
// }
// console.log(sadReality(record))

const superbowlWin = function (record) {
    // const value = []
    const win = record.find(function(i){
        if (i.result === 'W') {
            return i.year
        } else {
            return 'undefined'
